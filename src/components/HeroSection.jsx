...
export default function HeroSection() {
  return (
    <div className="relative overflow-hidden" dir="rtl"
      style={{ background: 'linear-gradient(135deg, #071629 0%, #0f2d5e 55%, #1a4080 100%)' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-20 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div
            ...
            style={{ background: 'rgba(201,168,76,0.12)', border: '1px solid rgba(201,168,76,0.38)', color: '#d4b96a' }}
          ...
          >
            קנה דירה בכוח <span style={{ color: '#c9a84c' }}>הקבוצה</span>
            <br />
          ...
          >
            ...
            {' · '}ממוצע חיסכון <strong style={{ color: '#c9a84c' }}>₪347,000</strong> לדירה
          </motion.p>
        </div>
      </div>
    </div>
