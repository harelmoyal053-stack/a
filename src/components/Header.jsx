  ...
  return (
    <header className="sticky top-0 z-50 bg-white/98 backdrop-blur-md border-b border-gray-100 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 py-3">
        <div className="flex items-center justify-between gap-4" dir="rtl">
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1 shrink-0">
              ...
              <span className="w-2 h-2 rounded-full bg-green-500 mb-3 ml-0.5 animate-pulse inline-block"></span>
            </div>
            ...
            {/* Create Store Button */}
            <button className="flex items-center gap-2 bg-green-600 hover:bg-green-700 active:bg-green-800 text-white px-4 py-2.5 rounded-xl text-sm font-bold transition-all duration-200 shadow-md shadow-green-200 hover:shadow-green-300 hover:shadow-lg shrink-0 hidden sm:flex">
        ...
        {/* Mobile Search + Create Store Row */}
