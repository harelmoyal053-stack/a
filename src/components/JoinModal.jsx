...
export default function JoinModal({ deal, onConfirm, onClose }) {
  ...
  return (
    ...
    >
      ...
      {/* Modal */}
      <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden animate-[fadeInUp_0.3s_ease]">

        {/* Header */}
        <div className="bg-gradient-to-l from-green-600 to-emerald-500 px-6 py-5 text-white">
          ...
          <div className="mt-4 bg-white/15 rounded-2xl p-3 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium">המחיר הבא: <span className="font-black text-yellow-300">₪{deal.nextPrice}</span></span>
            </div>
            <div className="text-right">
              <div className="text-xl font-black">₪{deal.currentPrice}</div>
        ...
        {step === 1 ? (
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="flex gap-3 mb-5">
              <div className="flex items-center gap-1.5 text-xs text-gray-600 flex-1 justify-center bg-gray-50 rounded-xl py-2">
              ...
              <div className="flex items-center gap-1.5 text-xs text-gray-600 flex-1 justify-center bg-gray-50 rounded-xl py-2">
                ...
                <span>{deal.currentBuyers} חברים</span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-1.5">מספר טלפון</label>
                <input
                  type="tel"
                  value={phone}
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  className="mt-0.5 w-4 h-4 text-green-600 rounded focus:ring-green-400 shrink-0"
                />
            ...
            <button
              ...
              className="w-full mt-5 bg-gradient-to-l from-green-600 to-emerald-500 disabled:from-gray-300 disabled:to-gray-300 text-white py-3.5 rounded-xl font-bold text-base transition-all duration-200 shadow-md shadow-green-200 hover:shadow-lg hover:shadow-green-300 disabled:shadow-none flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
          ...
          <div className="p-8 text-center">
            ...
            <p className="text-gray-500 text-sm mb-6">
              אנחנו נשלח לך SMS כשהמחיר ירד. רק <strong className="text-green-600">{deal.targetBuyers - deal.currentBuyers - 1}</strong> קונים נוספים נדרשים!
            </p>
            <div className="bg-green-50 border border-green-200 rounded-2xl p-4 mb-6 text-right">
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-sm font-semibold text-gray-600">המחיר שלך עכשיו</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="font-black text-xl text-emerald-600">₪{deal.nextPrice}</span>
                <span className="text-sm font-semibold text-gray-600">המחיר הבא</span>
              </div>
            </div>
            <button
              onClick={() => onConfirm(deal)}
              className="w-full bg-gradient-to-l from-green-600 to-emerald-500 text-white py-3.5 rounded-xl font-bold text-base shadow-md shadow-green-200"
            >
              מעולה, תודה!
            </button>
          </div>
