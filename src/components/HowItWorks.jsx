      ...
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div className="text-center mb-12"
          ...
          <h2 className="text-3xl md:text-4xl font-black mt-4 mb-3" style={{ color: '#0d3320' }}>
            4 צעדים לחיסכון של <span style={{ color: '#22a855' }}>עשרות אחוזים</span>
          </h2>
          ...
          {STEPS.map((step, i) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-base font-black mb-2" style={{ color: '#0d3320' }}>{step.title}</h3>
